...
1. Clone the Repository <pre> ```git clone https://github.com/JoshuaScherer1996/pokemon_terminal_game.git``` </pre> <pre> ```cd pokemon_terminal_game/"Pokemon Terminal Game" ``` </pre>
