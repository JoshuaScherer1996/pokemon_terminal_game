...
let pokemonHP: [Int] = [
    45, 60, 80, 39, 58, 78, 44, 59, 79, 45, 50, 60, 40, 45, 65, 40, 63, 83, 30, 55,
    40, 65, 35, 60, 35, 60, 50, 75, 55, 70, 90, 46, 61, 81, 70, 95, 38, 73, 115,
...
let pokemonCatchDifficulty: [Int] = [
    ...
    150, 160, 160, 200, 5, 250, 250, 250, 80, 90, 220, 250, 250
]
